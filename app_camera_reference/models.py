...
class CameraIntreface (models.Model):
    attribute_name = models.CharField(max_length=50, default='Интерфейсы камеры' )
    attribute_id = models.CharField(max_length=50, default='5236')
    value = models.CharField(max_length=100, blank=True)
    dictionary_value_id = models.CharField(max_length=20, default=1)
    is_collection = models.BooleanField(default=True)
    is_required = models.BooleanField(default=False)
